...
Set-EnvValue "YOLO_TRACKER" "bytetrack"
Set-EnvValue "YOLO_TRACK_LOW_CONFIDENCE" "0.05"
Set-EnvValue "YOLO_NEW_TRACK_CONFIDENCE" "0.18"
...
Write-Host "Redemarrez avec .\scripts\start_local.ps1 puis lancez uniquement le test de 2 min (1 min continue par mi-temps)."
